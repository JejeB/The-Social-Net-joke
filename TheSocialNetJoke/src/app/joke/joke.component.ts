...
@Component({
  ...
  <div class="col-sm" *ngIf="selected[3]">
    <i class="material-icons col-sm" style="background:coral" (click)="deselectAll()">sentiment_very_satisfied</i>
  </div>
  ...
  <div class="col-sm" *ngIf="selected[2]">
    <i class="material-icons col-sm" style="background:coral" (click)="deselectAll()">sentiment_satisfied</i>
  </div>
  ...
  <div class="col-sm" *ngIf="selected[1]">
    <i class="material-icons col-sm" style="background:coral" (click)="deselectAll()">sentiment_dissatisfied</i>
  </div>
  <div class="col-sm" *ngIf="!selected[0]">
    <i class="material-icons col-sm" (click)="rank(0)" >sentiment_very_dissatisfied</i>
  </div>
  <div class="col-sm" *ngIf="selected[0]">
    <i class="material-icons col-sm" style="background:coral" (click)="deselectAll()">sentiment_very_dissatisfied</i>
  </div>
